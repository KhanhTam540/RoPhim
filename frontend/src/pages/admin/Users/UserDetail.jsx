...
import { 
  ...
  FaSave, FaTimes, FaTrash, FaEnvelope,
  FaCalendar, FaClock, FaStar, FaHeart, FaComment,
  FaUser, FaUserTag, FaToggleOn, FaToggleOff,
  FaPhone, FaMapMarkerAlt, FaBirthdayCake,
  FaVenusMars
} from 'react-icons/fa'
...
const UserDetail = () => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await adminUserApi.updateUser(id, updatedData)
            ...
            <div className="bg-rophim-card rounded-lg p-6 text-center border border-rophim-border sticky top-24">
              ...
              {!editing ? (
                <>
                  ...
                  <p className="text-rophim-textSecondary mb-3">@{user.username}</p>
                  ...
                  <div className="mt-4 space-y-2 text-left">
                    <div className="flex items-center space-x-3 text-sm">
                      ...
                      <span className="text-rophim-textSecondary">{user.email}</span>
                    </div>
                    {user.phoneNumber && (
                      <div className="flex items-center space-x-3 text-sm">
                        <FaPhone className="text-gray-400" size={14} />
                        <span className="text-rophim-textSecondary">{user.phoneNumber}</span>
                      </div>
                    )}
                    {user.gender && (
                      <div className="flex items-center space-x-3 text-sm">
                        <FaVenusMars className="text-gray-400" size={14} />
                  ...
                  <div className="mt-6 space-y-2">
                    <button
                      onClick={() => setActionDialog({ isOpen: true, action: user.isActive ? 'lock' : 'unlock' })}
                    ...
                    >
                      {user.isActive ? <FaBan size={14} /> : <FaCheck size={14} />}
                      <span>{user.isActive ? 'Khóa tài khoản' : 'Mở khóa tài khoản'}</span>
                    </button>
                    
                    <button
                      onClick={() => setActionDialog({ isOpen: true, action: 'reset-password' })}
                      className="w-full flex items-center justify-center space-x-2 py-2 bg-purple-500/10 hover:bg-purple-500/20 text-purple-500 rounded-lg transition-colors"
                    >
                      <FaKey size={14} />
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center space-x-2 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 rounded-lg transition-colors"
                    >
                      <FaTrash size={14} />
                ...
                <div className="mt-4 text-left">
                  <h3 className="text-lg font-semibold mb-4 flex items-center">
                    <FaEdit className="mr-2 text-blue-500" size={18} />
                    Chỉnh sửa thông tin
                  </h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="flex items-center space-x-2 text-sm font-medium mb-2">
                        <FaUserTag className="mr-2 text-gray-400" size={14} />
                        Vai trò
                      </label>
                      <select
                        name="role"
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-rophim-card rounded-lg p-6 border border-rophim-border">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-rophim-textSecondary text-sm">Số điện thoại</p>
                  <p className="font-medium">{user.phoneNumber || 'Chưa cập nhật'}</p>
                </div>
                <div>
                  <p className="text-rophim-textSecondary text-sm">Giới tính</p>
            ...
            <div className="bg-rophim-card rounded-lg p-6 border border-rophim-border">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 bg-rophim-hover rounded-lg">
                  <FaClock className="mx-auto text-green-500 mb-2" size={24} />
